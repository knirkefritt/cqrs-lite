...
class EventSerializerImpl(private val cfg: EventSerializationMapConfig) : EventSerializer {
    ...
    override fun <T> serialize(event: T): String = gson.toJson(event)

    override fun <T> deserialize(json: String, clazz: Class<T>): T = gson.fromJson(json, clazz)
